...
namespace Valuator.Infrastructure
{
    ...
    {
        private readonly IHubContext<Valuator.RankHub> _hubContext;
        ...
        public RankCalculatedEventConsumer(
            IHubContext<Valuator.RankHub> hubContext,
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            consumer.ReceivedAsync += async (_, ea) =>
            {
                try
                {
                    ...
                    {
                        await _hubContext.Clients.Group(Valuator.RankHub.GroupFor(evt.Id)).SendAsync("RankReady", evt.Rank);
                    }
